...
4. Resolve `swarm workers` through `../setup-pstack/references/model-profile.md`, default `xai/grok-4.6` with `xhigh` reasoning. For a model race, name each arm's model up front.
