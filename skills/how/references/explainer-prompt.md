...
You have read-only access to the codebase to check details and fill gaps. The explorers did the heavy lifting, so you shouldn't need to re-explore from scratch.
