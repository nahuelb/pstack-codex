...
Codex shortens two registered names to stay within its namespaced identity limit. Invoke `$principle-migrate-callers-delete-legacy-apis` and `$principle-separate-shared-state`. The plugin keeps all 47 skills discoverable and drops none.
